...
<nav class="navbar">
    <div class="container">
        ...
        <br><br>       
        <a href="/product/add_product" class="btn btn-info float-left">ADD</a><br>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check-inline">
                            <label class="form-check-label">
                                <input form="delete-form" type="checkbox" class="delete-checkbox" name="<?= $res['id']; ?>" value="<?= $res['id']; ?>"></p>
                            </label>
                        </div>
                    </div>
                </div>
