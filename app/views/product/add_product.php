        ...
        <div class="col-md-12">
            <form  action="/product/add_product"  method="post" name="form" id="form1" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="name" ><span id="chkname"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="price" class="col-sm-2 control-label">Price</label>
                    <div class="col-sm-10">
                    <input type="number" step="1" min="1" name="price" class="form-control" id="price" ><span id="chkprice"></span>
                </div>
                </div>
                <div class="form-group">
                    <label for="typeSwitch" class="col-sm-2 control-label">Type switcher</label>
                    <div class="col-sm-10">
                    <select class="form-control" id="typeSwitch" name="typeSwitch">
